...
// NewHyperFleetLogger creates and returns a new HyperFleetLogger configured with a default verbosity level of 1.
// The returned logger has an empty extras map and no account identifier.
