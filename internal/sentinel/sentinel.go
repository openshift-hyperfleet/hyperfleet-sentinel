...
// NewSentinel creates a Sentinel configured with the given SentinelConfig, HyperFleetClient,
// DecisionEngine, broker Publisher, and HyperFleetLogger and returns a pointer to it.
func NewSentinel(
